...
public class ComprDataIO {
	...
	public ComprDataIO(Archives arc) {
		this.archive = arc;
	}
    ...
    public void init(FileHeaders hd) throws IOException {
...
//            }
	...
	public void setSubHeader(FileHeaders hd)
	{
		subHead = hd;
	...
	public FileHeaders getSubHeader()
	{
		return subHead;
	}
