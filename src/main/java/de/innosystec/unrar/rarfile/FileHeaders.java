 ...
 */
public class FileHeaders extends BlockHeader {

    private final Log logger = LogFactory.getLog(FileHeaders.class.getName());
    ...
    public FileHeaders(BlockHeader bh, byte[] fileHeader) {
	super(bh);
